# -*- coding: utf-8 -*-
"""
Created on Tue Aug 14 14:46:03 2018
...
orientation = dataset.iloc[:,16:18+1].values
...
plt.plot(range(2122,length), tr_accel[2122:length,0], color = 'red')
plt.plot(range(2122,length), tr_accel[2122:length,1] , color = 'green')
plt.plot(range(2122,length), tr_accel[2122:length,2] , color = 'blue')
plt.show()
np.savetxt("Partial_rot_transformed_data.csv", tr_accel, delimiter = ',')
