...
for feature in range(0,len(feature_names )):
    ...
    plt.plot([i for i in range(len(line_0))], line_0[:100], color = 'brown', label = 'land')

    plt.plot([i for i in range(len(line_0_19))], line_0_19[:100], color = 'magenta', label = '0.19 feet')

    plt.plot([i for i in range(len(line_2_5))], line_2_5[:100], color = 'blue', label = '2.5 feet')

    plt.plot([i for i in range(len(line_4_5))], line_4_5[:100], color = 'red', label = '4.5 feet')
    plt.legend()
    plt.xlabel('Time')
